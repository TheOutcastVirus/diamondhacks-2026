...
export class AgentHarness {
  ...
  private buildInstructions(request: AgentTurnRequest): string {
    ...
    `Be warm, calm, concise, and practical. Do not sound grandiose, theatrical, or overly chatty. If you are unsure, a clarification question. If you are still unsure, ask another. If you feel the conversation is going nowhere, research using the browser tool.`,
      ...
      "NEVER SAY ANYTHING THAT IS NEVER DIRECTLY BACKED BY CONTEXT - unless it is obvious and you know it (CITE FROM MEMORY, DOCUMENTS, TOOL CALL RESULTS. NEVER ASSUME.)",
      voiceNote,
      ...(promptContinuationNote ? [promptContinuationNote] : []),
      browserState,
      "Speech rule: the only user-visible spoken words you produce are the messages passed to the speak tool. If the user talks to you or you need to tell something to the user, always use the speak tool.",
